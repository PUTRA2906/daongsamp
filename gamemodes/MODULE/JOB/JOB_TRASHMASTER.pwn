//Trasher
#define     TRASH_BAG_VALUE     (1000)    	// value of a collected trash bag (default: 125)
...
IsATrashVeh(carid)
{
    for(new v = 0; v < sizeof(TrashCar); v++) {
        if(carid == TrashCar[v]) return 1;
    }
    return 0;
}
...
//buthcer
new
	bool: GetMeatBag[MAX_PLAYERS],
	StoremeatCP[MAX_PLAYERS] = {-1, ...};
