...
CMD:arrest(playerid, params[])
{
	...
	if(denda < 100 || denda > 100000)
        return Error(playerid, "The specified denda can't be below 100 or above 1,000.00.");
...
CMD:ticket(playerid, params[])
{
	...
	if(ticket < 0 || ticket > 50000)
		return Error(playerid, "Ammount max of ticket is $1 - $500.00!");
