...
House_Type(houseid)
{
	if(hData[houseid][hType] == 1)
	{
	    switch(random(1))
		{
			case 0://apart
			{
				hData[houseid][hIntposX] = 1430.3279;
				hData[houseid][hIntposY] = -1221.1814;
				hData[houseid][hIntposZ] = 152.8182;
				hData[houseid][hIntposA] = 259.8793;
...
CMD:myhouse(playerid)
{
	...
	ShowPlayerDialog(playerid, DIALOG_MY_HOUSES, DIALOG_STYLE_LIST, "{FF0000}ILRP:RP: {0000FF}Houses", CMDSString, "Select", "Cancel");
	return 1;
}
